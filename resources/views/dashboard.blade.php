            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
                <div class="bg-white border border-gray-100 rounded-xl p-4">
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <span class="w-8 h-8 rounded-lg flex items-center justify-center" style="background:#FDEBE8;color:#E24B3A;">
                            <x-nav-icon name="check" class="w-4 h-4" />
                        </span>
                    </div>
                ...
                <div class="bg-white border border-gray-100 rounded-xl p-4">
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <span class="w-8 h-8 rounded-lg flex items-center justify-center" style="background:#E1F3E6;color:#2AA152;">
                            <x-nav-icon name="user" class="w-4 h-4" />
                        </span>
                    </div>
                ...
                <div class="bg-white border border-gray-100 rounded-xl p-4">
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <span class="w-8 h-8 rounded-lg flex items-center justify-center" style="background:#F1E5F2;color:#8E3E96;">
                            <x-nav-icon name="wallet" class="w-4 h-4" />
                        </span>
                    </div>
                ...
                <div class="bg-white border border-gray-100 rounded-xl p-4">
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <span class="w-8 h-8 rounded-lg flex items-center justify-center" style="background:#E1F0F7;color:#0F5C78;">
                            <x-nav-icon name="book" class="w-4 h-4" />
                        </span>
                    </div>
                    ...
                    <table class="min-w-full text-sm">
                        <thead>
                            <tr class="border-t border-gray-100">
                                <th class="text-left px-5 py-2 text-xs font-medium text-gray-500">Guru</th>
                                <th class="text-left px-5 py-2 text-xs font-medium text-gray-500">Kelas</th>
                                <th class="text-left px-5 py-2 text-xs font-medium text-gray-500">Status</th>
                                <th class="text-right px-5 py-2 text-xs font-medium text-gray-500">Nominal</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($presensiTerbaru as $p)
                                <tr class="border-t border-gray-100">
                                    ...
                                    <td class="px-5 py-3 text-gray-600">{{ $p->jadwal->kelas->nama_kelas ?? '-' }}</td>
                                    <td class="px-5 py-3">
                                        <span @class([
                            ...
                            @empty
                                <tr class="border-t border-gray-100">
                                    <td colspan="4" class="px-5 py-6 text-center text-gray-500">Belum ada presensi tercatat.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
